...
Group-блок с вложенной структурой, сохранённый как паттерн = готовый organism. Может быть синхронизированным (изменения применяются везде) или несинхронизированным (копия). Подробнее — в разделе [Паттерны (Block Patterns)](./patterns/index.md).
