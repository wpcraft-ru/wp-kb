...
Связанные страницы: [theme.json — основа дизайн-системы](./theme-json.md), [Дизайн-системы в WordPress](./design-systems.md), [Figma → WordPress](./figma-to-wordpress.md), [DESIGN.md](./design-md.md).
...
- [theme.json — основа дизайн-системы](./theme-json.md) — Скругления через `settings.border.radiusSizes` (WP 6.9+).
