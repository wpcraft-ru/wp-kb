...
Связанные страницы: [Design Tokens в theme.json](./design-tokens.md), [Дизайн-системы в WordPress](./design-systems.md), [Figma → WordPress](./figma-to-wordpress.md), [DESIGN.md](./design-md.md).
