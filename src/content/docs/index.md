...
- [Шаблон: Договор на разработку ПО (фриланс)](./legal/templates/contract-freelance.md) — Помесячный Agile-договор между самозанятым фрилансером и компанией-заказчиком с недельным review, авансом на следующий месяц и итоговой оплатой по результатам месяца.
